...
export const userReducer = createReducer(initialState, (builder) => {
    builder
        .addCase("GET_USER_REQUEST", (state, action) => {
            state.loading = true;
        })
...
export const updateReducer = createReducer(initialState, (builder) => {
    builder
        ...
        .addCase("ADD_TIMELINE_REQUEST", (state, action) => {
            state.loading = true;
        })
        ...
        .addCase("DELETE_TIMELINE_REQUEST", (state, action) => {
            state.loading = true;
        })
        ...
        .addCase("ADD_YOUTUBE_REQUEST", (state, action) => {
            state.loading = true;
        })
        ...
        .addCase("DELETE_YOUTUBE_REQUEST", (state, action) => {
            state.loading = true;
        })
        ...
        .addCase("CONTACT_US_REQUEST", (state, action) => {
            state.loading = true;
        })
